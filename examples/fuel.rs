//! Example of limiting a WebAssembly function's runtime using "fuel
//! consumption".
...
fn main() -> Result<()> {
	...
	// Invoke `fibonacci` export with higher and higher numbers until we exhaust
	// our fuel.
	let fibonacci =
		instance.get_typed_func::<i32, i32>(&mut store, "fibonacci")?;
	for n in 1.. {
