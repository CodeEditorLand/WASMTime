...
fn main() -> Result<()> {
	...
	// Initialize global per-process state. This state will be shared amongst
	// all threads. Notably this includes the compiled module as well as a
	// `Linker`, which contains all our host functions we want to define.
